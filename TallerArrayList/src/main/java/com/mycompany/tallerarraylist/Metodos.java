...
public class Metodos {
    public static void definicionArrayList() {
        System.out.println("Definicion de ArrayList:");
    ...
    public static void diferencias() {
        ...
        System.out.println("1. Capacidad dinamica vs estatica:");
        ...
        System.out.println("   - Debido a la sincronizacion, Vector es mas lento que ArrayList.");
    ...
    public static void metodosArrayList() {
        System.out.println("Metodos de ArrayList en Java:");
